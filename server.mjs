...
app.get('/api/vehicles/:id', async (req, res) => {
  try {
    ...
    console.error('[YNR] product vehicle:', error?.message || error)
    return res.status(503).json({ message: 'Fiche véhicule temporairement indisponible.' })
  }
})
